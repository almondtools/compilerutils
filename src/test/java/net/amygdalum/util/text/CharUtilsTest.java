...
import static net.amygdalum.util.text.CharUtils.lengths;
...
public class CharUtilsTest {
    ...
    public void testMinMaxLength() throws Exception {
        ...
        assertThat(minLength(asList(new char[] { 'a', 'b', 'c' }, new char[] { 'a', 'b' })), equalTo(2));
        assertThat(maxLength(asList(new char[] { 'a', 'b' }, new char[] { 'a', 'b', 'c' })), equalTo(3));
        assertThat(maxLength(asList(new char[] { 'a', 'b', 'c' }, new char[] { 'a', 'b' })), equalTo(3));
    }
    ...
    @Test
    public void testLengthsReturnsSortedArrayOfUniqueLengths() throws Exception {
        assertThat(lengths(asList(new char[] { 'a', 'b' }, new char[] { 'a', 'b', 'c' })), intArrayContaining(3, 2));
        assertThat(lengths(asList(new char[] { 'a', 'b' }, new char[] { 'a', 'b', 'c' }, new char[] { 'd', 'e', 'f' })), intArrayContaining(3, 2));
        assertThat(lengths(asList(new char[] { 'a', 'b', 'c' }, new char[] { 'a', 'b' })), intArrayContaining(3, 2));
    }
